 ...
 */
function ConnectButton({ label, isHigher, sorobanContext, }) {
    const { connect } = sorobanContext;
    /**
     * Opens the connection modal.
     *
     */
    const openConnectModal = () => __awaiter(this, void 0, void 0, function* () {
        yield connect();
    });
    /**
     ...
     */
    react_1.default.createElement("button", { style: { height: isHigher ? 50 : 38 }, onClick: openConnectModal }, label));
}
